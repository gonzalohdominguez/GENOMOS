...
class NewGenotypeForm(object):
    def setupUi(self, NewGenotypeForm):
        ...
        self.label_6.setGeometry(QRect(10, 130, 321, 16))
...
"}")
    ...
    def retranslateUi(self, NewGenotypeForm):
        NewGenotypeForm.setWindowTitle(QCoreApplication.translate("NewGenotypeForm", u"New Sample", None))
        self.label.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">NEW SAMPLE</span></p></body></html>", None))
        self.label_3.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Melting Temperature (1534): </span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Melting Temperature (1016): </span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Standard Melting Temperature 1016 (resistant): </span></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Standard Melting Temperature 1016 (sensitive): </span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Standard Melting Temperature 1016 (heterozygous): </span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Standard Melting Temperature 1534 (heterozygous): </span></p></body></html>", None))
        self.label_7.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Standard Melting Temperature 1534 (sensitive): </span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("NewGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Standard Melting Temperature 1534 (resistant): </span></p></body></html>", None))
        self.addButton.setText(QCoreApplication.translate("NewGenotypeForm", u"ADD", None))
        self.cancelButton.setText(QCoreApplication.translate("NewGenotypeForm", u"CANCEL", None))
    # retranslateUi
