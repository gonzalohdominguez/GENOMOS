...
"}")
        ...
        self.label_3.setGeometry(QRect(250, 60, 121, 21))
...
"}")
        ...
        self.label_6.setGeometry(QRect(10, 630, 161, 16))
...
"}")
    ...
    def retranslateUi(self, ListGenotypeForm):
        ...
        self.label.setText(QCoreApplication.translate("ListGenotypeForm", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Nueva Muestra</span></p></body></html>", None))
        self.open_edit_button.setText("")
        self.label_2.setText(QCoreApplication.translate("ListGenotypeForm", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Editar Muestra</span></p></body></html>", None))
        self.delete_genotype_button.setText("")
        self.label_3.setText(QCoreApplication.translate("ListGenotypeForm", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Eliminar Muestra</span></p></body></html>", None))
        self.info_genotype_button.setText("")
        self.label_4.setText(QCoreApplication.translate("ListGenotypeForm", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Informaci\u00f3n</span></p></body></html>", None))
        self.logo_cenexa_button.setText("")
        self.logo_creg.setText("")
        self.label_5.setText(QCoreApplication.translate("ListGenotypeForm", u"Buscar por:", None))
        self.searchButton.setText(QCoreApplication.translate("ListGenotypeForm", u"BUSCAR", None))
        self.refreshButton.setText(QCoreApplication.translate("ListGenotypeForm", u"ACTUALIZAR", None))
        self.label_6.setText(QCoreApplication.translate("ListGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Cantidad de registros: </span></p></body></html>", None))
        self.genotypesQtyLabel.setText(QCoreApplication.translate("ListGenotypeForm", u"#", None))
        self.tabla_resultante_button.setText(QCoreApplication.translate("ListGenotypeForm", u"Resultados", None))
        self.abrir_archivo_excel.setText(QCoreApplication.translate("ListGenotypeForm", u"Abrir datos", None))
        self.guardar_archivo_excel.setText(QCoreApplication.translate("ListGenotypeForm", u"Guardar datos", None))
        self.delete_datos.setText(QCoreApplication.translate("ListGenotypeForm", u"Eliminar datos", None))
    # retranslateUi
