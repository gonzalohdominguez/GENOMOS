...
"}")
    ...
    def retranslateUi(self, EditGenotypeForm):
        EditGenotypeForm.setWindowTitle(QCoreApplication.translate("EditGenotypeForm", u"Editar Muestra", None))
        self.label.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">EDITAR MUESTRA</span></p></body></html>", None))
        self.label_3.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting (1534): </span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting (1016): </span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting est\u00e1ndar 1016 (RR): </span></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting est\u00e1ndar 1016 (SS): </span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting est\u00e1ndar 1016 (SR): </span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting est\u00e1ndar 1534 (SR): </span></p></body></html>", None))
        self.label_7.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting est\u00e1ndar 1534 (SS): </span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("EditGenotypeForm", u"<html><head/><body><p><span style=\" font-weight:600;\">Temperatura de melting est\u00e1ndar 1534 (RR): </span></p></body></html>", None))
        self.editButton.setText(QCoreApplication.translate("EditGenotypeForm", u"EDITAR", None))
        self.cancelButton.setText(QCoreApplication.translate("EditGenotypeForm", u"CANCELAR", None))
    # retranslateUi
